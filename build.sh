...
echo
echo
echo "Starting install Asterisk version 18!"
yum -y update
yum -y groupinstall core base "Development Tools"
yum install -y epel-release dmidecode gcc-c++ ncurses-devel libxml2-devel make wget openssl-devel newt-devel kernel-devel sqlite-devel libuuid-devel gtk2-devel
yum install -y jansson-devel binutils-devel libedit libedit-devel svn git epel-release audiofile-devel psmisc sox uuid-devel htop nload
echo '[irontec]
...
chmod 777 -R /var/lib/asterisk/sounds/en/custom
echo
